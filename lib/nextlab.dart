...
class nextlab extends StatelessWidget {
  @override
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Next Lab. Solution Tunisie ',
            ...
            RichText(
              text: TextSpan(
                text:
                    '✓ Mise en place d une base de données sous MySQL ✓ Établissement de la connexion entre l application et la base de données. ✓ Traitement des données (ajout, suppression, modification).',
                style: TextStyle(
                  fontSize: 20.0,
            ...
            RaisedButton(
              ...
              onPressed: () => _launchURL('https://www.nextlabs.com'),
